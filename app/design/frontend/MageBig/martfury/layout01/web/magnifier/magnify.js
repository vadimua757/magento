...
define([
    ...
    return function (config, element) {
        ...
        isTouchEnabled = isTouchEnabled && (navigator.maxTouchPoints || navigator.msMaxTouchPoints) && navigator.userAgent.match(/Android|webOS|iPhone|iPad|iPod|BlackBerry|Windows Phone/i);
