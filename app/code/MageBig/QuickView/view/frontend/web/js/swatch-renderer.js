    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _create: function () {
            var options = this.options,
                gallery = $('[data-gallery-role=gallery-placeholder]', '.quickview-wrap'),
                isProductViewExist = $('body.magebig-product-qv').size() > 0,
                $main = isProductViewExist ?
                    this.element.parents('.quickview-wrap') :
        ...
        _LoadProductMedia: function () {
            ...
            if ($('body.magebig-product-qv').size() > 0) {
                //Product Page
                productId = $('#quickview-info-main #product_addtocart_form [name="product"]').val();
        ...
        _EnableProductMediaLoader: function ($this) {
            ...
            if ($('body.magebig-product-qv').size() > 0) {
                $this.parents('.quickview-wrap').find('.photo.image')
        ...
        _ProductMediaCallback: function ($this, response) {
            var isProductViewExist = $('body.magebig-product-qv').size() > 0,
                $main = isProductViewExist
                    ? $this.parents('.quickview-wrap') : $this.parents('.product-item-info'),
                $widget = this,
                images = [],
